package com.shinsegae.android.common;
...
import com.shinsegae.android.ssgosp.R;
...
public class CTCalendarView extends Activity implements OnClickListener {
    ...
    ArrayList<String> daylist; //일자 목록을 가지고 있는다. 1,2,3,4,...
  ...
  //달력에 표시할 일자를 배열에 넣어 구성한다. 
    ...
    private void makeCalendar()
    {
        ...
        oneday_height = getWindow().getWindowManager().getDefaultDisplay().getHeight() * 2 / 3;
